...
@Serializable data class ShiftRow(val id:String,@SerialName("shift_date") val shiftDate:String="",val area:String="",@SerialName("start_time") val start:String?=null,@SerialName("end_time") val end:String?=null,val notes:String?=null)
